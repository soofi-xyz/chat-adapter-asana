...
- `@soofi-xyz/chat-adapter-asana-cdk` — AWS CDK construct that provisions an HTTP API, stores the handshake secret in AWS Secrets Manager, and registers the Asana webhook against the bot's *My Tasks* user task list.